...
/* Timer 2 */
#define TIMER2_IR      (*((volatile unsigned long *) 0xE0007000))
#define TIMER2_TCR     (*((volatile unsigned long *) 0xE0007004))
#define TIMER2_TC      (*((volatile unsigned long *) 0xE0007008))
#define TIMER2_PR      (*((volatile unsigned long *) 0xE000700C))
#define TIMER2_PC      (*((volatile unsigned long *) 0xE0007010))
#define TIMER2_MCR     (*((volatile unsigned long *) 0xE0007014))
#define TIMER2_MR0     (*((volatile unsigned long *) 0xE0007018))
#define TIMER2_MR1     (*((volatile unsigned long *) 0xE000701C))
#define TIMER2_MR2     (*((volatile unsigned long *) 0xE0007020))
#define TIMER2_MR3     (*((volatile unsigned long *) 0xE0007024))
#define TIMER2_CCR     (*((volatile unsigned long *) 0xE0007028))
#define TIMER2_CR0     (*((volatile unsigned long *) 0xE000702C))
#define TIMER2_CR1     (*((volatile unsigned long *) 0xE0007030))
#define TIMER2_CR2     (*((volatile unsigned long *) 0xE0007034))
#define TIMER2_CR3     (*((volatile unsigned long *) 0xE0007038))
#define TIMER2_EMR     (*((volatile unsigned long *) 0xE000703C))
